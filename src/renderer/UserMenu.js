...
import { Error404, UserCircle, Upload } from "tabler-icons-react";
...
export default function UserMenu({openUploadModal}) {
  ...
  if (user) {
    return (
      ...
      >
        ...
        <Menu.Dropdown>
          <Menu.Item icon={<UserCircle size={18} />}>{user.email}</Menu.Item>
          <Menu.Item icon={<Upload size={18} />} onClick={openUploadModal}>Upload new version</Menu.Item>
          <Divider />
